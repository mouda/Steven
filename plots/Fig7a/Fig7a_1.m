...
headNum = [ mean(finalHead50(:,idx)) mean(finalHead100(:,idx)) mean(finalHead150(:,idx)) mean(finalHead195(:,idx))];

idx24 = 7;
machineNum24 = [50  100  150 195];
headNum24 = [ mean(finalHead50_CR24(:,idx24)) mean(finalHead100_CR24(:,idx24)) mean(finalHead150_CR24(:,idx24))  mean(finalHead195_CR24(:,idx24))];
idx36 = 7;
machineNum36 = [50  100  150 195];
...
headNum36 = [ mean(finalHead50_CR36(:,idx36)) mean(finalHead100_CR36(:,idx36)) mean(finalHead150_CR36(:,idx36))  mean(finalHead195_CR36(:,idx36))];
