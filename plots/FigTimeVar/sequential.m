...
close all;
x = 0.0:0.1:0.5;
baselineEntropy = dlmread('data/entropy_Baseline_Q_16_N50.out');
branchboundEntropy = dlmread('data/entropy_Branchbound_Q_16_N50.out');
greedyPhysical = dlmread('data/entropy_GreedyPhysical_Q_16_N50.out');
