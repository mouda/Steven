...
plot(headx,mean(secondResors4b+firstResors4b)./noclu,'*-','LineWidth',1.5,'DisplayName','Two Tiers: Head\leqm','Color',MC_colorMap(i+17,:),'MarkerSize',10);hold on;
plot(headx,mean(secondResors4b)./noclu,'d-','LineWidth',1.5,'DisplayName','Tier-2: Head\leqm','Color',MC_colorMap(i+6,:),'MarkerSize',10); hold on;
plot(headx,mean(firstResors4b)./noclu,'x-','LineWidth',1.5,'DisplayName','Tier-1: Head\leqm','Color',MC_colorMap(i,:),'MarkerSize',10);
