...
MinPowerMILP::MinPowerMILP(Index n, Index m, Index nnz_jac_g, Index nnz_h_lag,
    const double tau,
...
bool 
MinPowerMILP::get_variables_types(Index n, VariableType* var_types)
{
...
bool 
MinPowerMILP::get_variables_linearity(Index n, Ipopt::TNLP::LinearityType* var_types)
{
...
bool 
MinPowerMILP::get_constraints_linearity(Index m, Ipopt::TNLP::LinearityType* const_types)
{
...
bool 
MinPowerMILP::get_nlp_info(Index& n, Index&m, Index& nnz_jac_g,
...
bool 
MinPowerMILP::get_bounds_info(Index n, Number* x_l, Number* x_u,
...
bool 
MinPowerMILP::get_starting_point(Index n, bool init_x, Number* x,
...
bool
MinPowerMILP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  assert(n==m_numVariables);
...
bool
MinPowerMILP::eval_g(Index n, const Number* x, bool new_x, Index m, Number* g)
{
  assert(n==m_numVariables);
  assert(m==m_numConstraints);
...
bool
MinPowerMILP::eval_jac_g(Index n, const Number* x, bool new_x,
...
bool
MinPowerMILP::eval_h(Index n, const Number* x, bool new_x,
