...
do
  ...
  do
    echo "
    ### Job name
    #PBS -N ULSA2i3_MC_runHN_N195_$addue
    ### out files
    #PBS -e ./log/ULSA2i3_MC_runHN_N195_${addue}_${topoIdx}.err
    #PBS -o ./log/ULSA2i3_MC_runHN_N195_${addue}_${topoIdx}.log
    ...
    echo " 
    ../../../../ULSA2i3_MC/ULSA2i3_MC 195 $addue 8 0 180 ../../../mapFile/mapFile_uni_195_r500/mapFile_uniR500_N195_${topoIdx}.txt 0.477 2 1 1 0.95 0 20000 
    " >> ./run_temp.sh
    echo '
