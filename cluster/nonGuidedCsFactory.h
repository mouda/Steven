#ifndef _NONGUIDEDCSFACTORY_
#define _NONGUIDEDCSFACTORY_

#include <iostream>
#include "csFactory.h"
#include "nonGuidedSACluster.h"

class NonGuidedCsFactory: public CsFactory
{
  public:
    NonGuidedCsFactory(Map const * const, CORRE_MA_OPE const * const );
    ~NonGuidedCsFactory();
  ...
  private:
    ...
    NonGuidedSACluster*    m_ptrToolSA; 
