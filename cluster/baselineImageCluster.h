...
*/
#ifndef BaselineImageCluster_H
#define BaselineImageCluster_H
...
class ULCS1b;
class ULAGENT;
class BaselineImageCluster :public SABASE
{
public:
...
//-------------------------------------------------------------------//
  ...
  struct compareDis
  {
    const BaselineImageCluster& mySA;// data member
    compareDis(const BaselineImageCluster& sa) : mySA(sa) {} // constructor
  ...
  bool iniDone;
  bool *aryFlagHRDone; //If it is true means Head Rotate have been done in this structure, starrt from BaselineImageCluster
