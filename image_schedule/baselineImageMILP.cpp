...
BaselineImageMILP::BaselineImageMILP(Index n, Index m, Index nnz_jac_g, Index nnz_h_lag,
    const double tau,
...
bool 
BaselineImageMILP::get_variables_types(Index n, VariableType* var_types)
{
...
bool 
BaselineImageMILP::get_variables_linearity(Index n, Ipopt::TNLP::LinearityType* var_types)
{
...
bool 
BaselineImageMILP::get_constraints_linearity(Index m, Ipopt::TNLP::LinearityType* const_types)
{
...
bool 
BaselineImageMILP::get_nlp_info(Index& n, Index&m, Index& nnz_jac_g,
...
bool 
BaselineImageMILP::get_bounds_info(Index n, Number* x_l, Number* x_u,
...
bool 
BaselineImageMILP::get_starting_point(Index n, bool init_x, Number* x,
...
bool 
BaselineImageMILP::eval_f(Index n, const Number* x, bool new_x, Number& obj_value)
{
  assert(n==m_numVariables);
  Number powerSum = 0.0;
  for (int i = 0; i < m_tier2NumSlot * m_numNodes; ++i) {
...
bool
BaselineImageMILP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  assert(n==m_numVariables);
...
bool
BaselineImageMILP::eval_g(Index n, const Number* x, bool new_x, Index m, Number* g)
{
  assert(n==m_numVariables);
  assert(m==m_numConstraints);
...
bool
BaselineImageMILP::eval_jac_g(Index n, const Number* x, bool new_x,
...
bool
BaselineImageMILP::eval_h(Index n, const Number* x, bool new_x,
...
void
BaselineImageMILP::finalize_solution(TMINLP::SolverReturn status,
