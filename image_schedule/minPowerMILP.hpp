...
//
// Date :  03/17/2006
#ifndef MINPOWERMILP_HPP
#define MINPOWERMILP_HPP
...
class MinPowerMILP : public TMINLP
{
public:
  MinPowerMILP(Index n, Index m, Index nnz_jac_g, Index nnz_h_lag,
      const double tau,
  ...
  /// virtual destructor.
  virtual ~MinPowerMILP(){}
  
  const std::vector<double>& GetVecSolution() { return m_vecSolution;} 

//  /** Copy constructor.*/   
//  MinPowerMILP(const MinPowerMILP &other):printSol_(other.printSol_), m_Gamma(1.0){}

  /** Assignment operator. no data = nothing to assign*/
  //MinPowerMILP& operator=(const MinPowerMILP&) {}
