...
//
// Date :  03/17/2006
#ifndef MINPOWERIMAGEMILP_HPP
#define MINPOWERIMAGEMILP_HPP
...
class MinPowerImageMILP : public TMINLP
{
public:
  MinPowerImageMILP(Index n, Index m, Index nnz_jac_g, Index nnz_h_lag,
      const double tau,
...
//  /** Copy constructor.*/   
//  MinPowerImageMILP(const MinPowerImageMILP &other):printSol_(other.printSol_), m_Gamma(1.0){}

  /** Assignment operator. no data = nothing to assign*/
  //MinPowerImageMILP& operator=(const MinPowerImageMILP&) {}
