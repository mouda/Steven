...
//
// Date :  03/17/2006
#ifndef BASELINEIMAGEMILP_HPP
#define BASELINEIMAGEMILP_HPP
...
class BaselineImageMILP : public TMINLP
{
public:
  BaselineImageMILP(Index n, Index m, Index nnz_jac_g, Index nnz_h_lag,
      const double tau,
  ...
  /// virtual destructor.
  virtual ~BaselineImageMILP(){}
  
  const std::vector<double>& GetVecSolution() { return m_vecSolution;} 

//  /** Copy constructor.*/   
//  BaselineImageMILP(const BaselineImageMILP &other):printSol_(other.printSol_), m_Gamma(1.0){}

  /** Assignment operator. no data = nothing to assign*/
  //BaselineImageMILP& operator=(const BaselineImageMILP&) {}
