...
int main(int argc, char* argv[])
{
  ...
  if(argc!=14)
  {
    ...
    cout<<"Example:Usage: winULSA4b8_DC 195 10 10 10 180 mapFile/mapFile_uni_195_r500/mapFile_uniR500_N195_2.txt 10000 2 2 3"<<endl;
  ...
  // Control Constant    //
  //---------------------//
  string iniFlag="kmedoids_distance";
