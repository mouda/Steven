...
void
ImagePowerUpdater::UpdateInterference( std::vector<double>& vecPower, const std::vector<int>& vecSupport)
{
...
void
ImagePowerUpdater::ChangeAllMemberPower( std::vector<double>& vecPower, 
...
double
ImagePowerUpdater::Solve(std::vector<double>& vecPower, const std::vector<int>& vecSupport)
{
  int statusFlag = -1;
...
bool
ImagePowerUpdater::CheckDifference(const std::vector<double>& vecPowerDiff ) const
{
...
bool
ImagePowerUpdater::CheckConverged(const std::vector<double>& vecPowerDiffRatio) 
{
