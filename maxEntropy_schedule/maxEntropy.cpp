...
double
MaxEntropy::ScheduleOneSlot( std::vector<int>& vecSupport )
{
...
double
MaxEntropy::ScheduleOneSlot( std::vector<int>& vecSupport, std::vector<double>& vecPower, const std::vector<double>& vecVariance)
{
...
double
MaxEntropy::OmegaValue(const int nodeName)
{
