...
void
MyIP::SetExtraConstraints( const std::vector<int>& extraConstraints)
{
  m_vecExtraConstraint.assign(extraConstraints.begin(), extraConstraints.end());
}

void 
MyIP::PrintExtraConstraints() const
{
...
bool 
MyIP::get_variables_types(Index n, VariableType* var_types)
{
...
bool 
MyIP::get_variables_linearity(Index n, Ipopt::TNLP::LinearityType* var_types)
{
...
bool 
MyIP::get_constraints_linearity(Index m, Ipopt::TNLP::LinearityType* const_types)
{
...
bool 
MyIP::get_nlp_info(Index& n, Index&m, Index& nnz_jac_g,
...
bool 
MyIP::get_bounds_info(Index n, Number* x_l, Number* x_u,
...
bool 
MyIP::get_starting_point(Index n, bool init_x, Number* x,
...
bool 
MyIP::eval_f(Index n, const Number* x, bool new_x, Number& obj_value)
{
  assert(n==m_numVariables);
...
bool
MyIP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  assert(n==m_numVariables);
...
bool
MyIP::eval_g(Index n, const Number* x, bool new_x, Index m, Number* g)
{
  assert(n==m_numVariables);
  assert(m==m_numConstraints);
  Eigen::MatrixXd matX = Eigen::MatrixXd::Zero(m_ptrCS->GetNumNodes(),m_ptrCS->GetNumHeads());
...
bool
MyIP::eval_jac_g(Index n, const Number* x, bool new_x,
...
bool
MyIP::eval_h(Index n, const Number* x, bool new_x,
...
void
MyIP::finalize_solution(TMINLP::SolverReturn status,
